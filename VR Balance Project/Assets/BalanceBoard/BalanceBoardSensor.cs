...
public class BalanceBoardSensor : MonoBehaviour
{
    ...
    public bool record_headset_board_collision = false;
    ...
    void Start()
    {
        ...
        server.Server("127.0.0.1", 27333, this);
    }
    void Update()
    {
        UItext.text = camera.position.y.ToString();
        
        if(record_headset_board_collision)
    ...
    {
        record_headset_board_collision = !record_headset_board_collision;
...
Debug.Log("Done");
    ...
    public void RecordBoardAndHeadset(string msg_parts)
    {
